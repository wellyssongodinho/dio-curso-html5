...
## Módulo I - Introdução ao curso HTML

- Autor: Wellysson Gomes Godinho
- Origem: Digital Innovation One

### Aula I - Estrutura básica
...
## Módulo II - Entendendo o que é semântica

### Aula I - Semântica - Parte 1

//semânticas iniciais do html
<div>
//semânticas criadas a partir de 2014
<section>: seção genérica
<header>: cabelho da página
<article>: conteúdo relevante
<aside>: conteúdo relacionado
<footer>: rodaté da página
<h1>-<h6>: Não foram criados na versão 5, mas utilizados para semântica

### Aula II - Semântica - Parte 2

Criação do arquivo "index.html"

## Módulo III - Como usar textos e links em HTML

### Aula I - Tags para textos
...
### Aula II - Tags para links

- <h1>: utilizado para definir text padrão h1
- <h2>: utilizado para definir text padrão h2
- <h3>: utilizado para definir text padrão h3
- <p>: utilizado para conteúdos

### Aula III - Tags para links

-<a href="<hiperlink">Link</a>
-<a href="mailto:<email">Email</a>
-<a target="_blank">Link em nova página</a>

### Aula IV - Exercícios

-Alteração do arquivo "index.html"

## Módulo IV - Como inserir imagens em seu site

### Aula I - Tags img

- Tag img
//src propriedade obrigatoria que identifica o local da imagem
<img src="<imagem>"> 

//alt propriedade opcional que mostra um texto na ausência da imagem
<img alt="<text>"> 
...
## Módulo V - Como organizar listas com HTLM

### Aula I - Tags li, ul e ol

- Tag <ul>: ordem dos itens não é importante
- Tag <ol>: cria uma ordenação dos itens na lista

### Aula II - Exercícios

-Alteração do arquivo "index.html"

## Módulo VI - Introdução e conceitos básicos do CSS3

### Aula I - Introdução ao CSS3

-Seletores: elementos da página html (a, p, h1, h3, etc)
-Declarações: propriedades que alteram as características dos seletores (color, font-size, etc)
-Propriedades para identificação de seletores: 
1- class: precidida por "." (.header)
2- id: precidada por "#" (#header) - usado uma única vez numa página
-Criando arquivo style.css
...
## Módulo VII - Estilizando elementos, textos e listas

### Aula I - Estilizando elementos

-Padding e Margin
  padding, padding-top, padding-right, padding-botton, padding-left
-Background
  background, background-color, background-image (url), background-position
-Border
  border, border-top, border-right, border-botton, border-left, border-widht, border-color, border-style, 
  border-top-width, border-top-color, border-top-style ...
  border-radius
-Alterar arquivo style.css and index.html

### Aula II - Estilizando textos
...
### Aula III - Estilizando listas

-list-style-type: square/upper-roman/"\1F44D"
-list-style-image: url('<image>')
-Alterar arquivo style.css and index.html

## Módulo VIII - Dimensão e alinhamento

### Aula I - Propriedades de dimensão e alinhamento
